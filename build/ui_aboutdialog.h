...
"color: rgb(0, 170, 255);"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Soxax", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Soxax</b> version", 0));
...
"Copyright \302\251 2017 The Soxax developers", 0));
    } // retranslateUi
