...
"color: rgb(0, 170, 255);"));
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 SOXAX"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 SOXAX"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 SOXAX"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 SOXAX"));
